...
class Trainer:
    ...
    def single_agent_train(self) -> None:
        ...
        for timestep in tqdm.tqdm(
            ...
            with torch.no_grad():
                # compute actions
                actions = self.agents.act(observations=observations, states=states, timestep=timestep, timesteps=self.timesteps)[0]
    ...
    def single_agent_eval(self) -> None:
        ...
        for timestep in tqdm.tqdm(
            ...
            with torch.no_grad():
                # compute actions
                outputs = self.agents.act(observations=observations, states=states, timestep=timestep, timesteps=self.timesteps)
