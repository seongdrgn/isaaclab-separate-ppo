...
from isaaclab.envs import DirectRLEnv, DirectMARLEnv, ManagerBasedRLEnv
...
def SkrlVecEnvWrapper(
    ...
    print(not isinstance(env.unwrapped, ManagerBasedRLEnv))
    print(not isinstance(env.unwrapped, DirectRLEnv))
    print(not isinstance(env.unwrapped, DirectMARLEnv))
